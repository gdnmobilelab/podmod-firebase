...
const errorMessages: any = {
  service_worker_url:
    "You must specify a service worker URL to receive the message (for iOS hybrid app)",
...
function parseIOSNotificationFromPayload(
  ...
  if (!notificationShow) {
    throw new Error(
      "There is no notification.show command in the payload to parse into iOS arguments"
    );
  }

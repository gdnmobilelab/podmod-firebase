...
function sendRequest(id, topicName, method, log) {
    return node_fetch_1.default(`https://iid.googleapis.com/iid/v1/${id}/rel/topics/${topicName}`, {
        method: method,
        headers: {
...
exports.subscribeOrUnsubscribe = function (req, res, next) {
    ...
    return sendRequest(id, topicName, req.method, req.log)
        ...
        return send_message_1.sendMessage({ registration: id }, send_message_1.MessageSendType.Registration, confirmationNotification, req.log, true);
    })
        .then((messageId) => {
        let json = {

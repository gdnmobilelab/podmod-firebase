...
function sendRequest(id, topicName, method, log) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let res = yield node_fetch_1.default(`https://iid.googleapis.com/iid/v1/${id}/rel/topics/${namespacedTopic}`, {
            method: method,
            headers: {
...
exports.subscribeOrUnsubscribe = function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            req.log.error({ error: jsonify_error_1.JSONifyError(err) }, "Failure when trying to set subscription action");
            next(err);
        }
    });
};

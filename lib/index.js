...
const http_cache_headers_1 = require("./util/http-cache-headers");
// import { batchOperation } from "./endpoints/batch";
const log_1 = require("./log/log");
const db_1 = require("./util/db");
const env_1 = require("./util/env");
const jwt_1 = require("./util/jwt");
const iap_check_1 = require("./security/iap-check");
...
function createServer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { log, dbStream } = yield db_1.withDBClient(c => log_1.createLogger(c));
        ...
        server.pre(cors.preflight, iap_check_1.verifyIAPHeader);
        ...
        server.use(restify.plugins.queryParser(), restify.plugins.bodyParser({
            ...
            rejectUnknown: true
        }), restify.plugins.requestLogger(), cors.actual, http_cache_headers_1.applyCachingHeaders);
        routes_1.setRoutes(server);
        ...
        let stop = function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield util_1.promisify(server.close).apply(server);

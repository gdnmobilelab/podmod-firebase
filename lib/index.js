...
function checkForKey(keyType) {
    return (req, res, next) => {
        ...
        else if (keyType === ApiKeyType.Admin &&
...
server.post("/topics/:topic_name/batch/subscribe", checkForKey(ApiKeyType.Admin), batch_1.batchOperation("subscribe"));
server.post("/topics/:topic_name/batch/unsubscribe", checkForKey(ApiKeyType.Admin), batch_1.batchOperation("unsubscribe"));
